...
function add_theme_scripts() {
    ...
    wp_enqueue_style('adobefonts', 'https://use.typekit.net/wbe5ltf.css', array(), '1.0');
...
Include the grouped-open-hours.php file to have access to the display_grouped_open_hours_using_options() function.
*/
require_once get_template_directory() . '/inc/grouped-open-hours.php';
